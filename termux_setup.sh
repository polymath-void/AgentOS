...
mkdir -p /tmp/agentos_pyav && cd /tmp/agentos_pyav
...
echo ""
echo "[3/4] Installing AgentOS and aiortc..."
cd /data/data/com.termux/files/home/Projects/AgentOS
pip install .
pip install aiortc
...
echo ""
echo "==================================================="
echo "✅ AgentOS WebRTC Swarm is natively compiled for Termux!"
echo "Run 'agentos' to boot the kernel."
echo "Run 'python3 -m agentos.telemetry.core.app' in a separate tab for the TUI Dashboard."
echo "==================================================="
